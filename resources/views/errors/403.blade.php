...
<head>
    ...
    <title>403 — Akses Ditolak | BusGo</title>
    <link href="https://fonts.googleapis.com/css2?family=Syne:wght@800&family=DM+Sans:wght@400;600&display=swap" rel="stylesheet">
    <style>
        :root{--bg:#0a0e1a;--surface:#111827;--accent:#f97316;--text:#f1f5f9;--text2:#94a3b8;--border:rgba(255,255,255,0.07);--red:#ef4444}
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .code{font-family:'Syne',sans-serif;font-size:96px;font-weight:800;line-height:1;background:linear-gradient(135deg,var(--red),#fb7185);-webkit-background-clip:text;-webkit-text-fill-color:transparent;margin-bottom:16px}
...
<body>
    <div class="wrap">
        ...
        <h1>Akses Ditolak</h1>
        <p>Maaf, Anda tidak memiliki izin mengakses halaman ini.<br>Halaman ini hanya untuk Administrator.</p>
        <div class="btns">
            @auth
